        ...
        <section className="relative pt-36 pb-16 md:pt-44 md:pb-24 overflow-hidden bg-mk-bg">
          ...
          <div className="max-w-5xl mx-auto px-6 text-center flex flex-col items-center">
            ...
            <motion.div
              ...
              className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#FAF5FF] border border-blue-200/80 text-[#5278FF] text-xs font-bold uppercase tracking-wider mb-6 shadow-[0_4px_20px_-4px_rgba(82,120,255,0.25)]"
            >
              <Mic size={14} className="text-[#5278FF]" />
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 w-full max-w-3xl mb-12">
              {METRICS.map((m, i) => (
                ...
                >
                  <div className="text-2xl md:text-3xl font-bold font-mono text-[#5278FF]">{m.val}</div>
              ...
              {FEATURES.map((c, i) => (
                ...
                >
                  <div className="flex items-center justify-between">
                    <div className="w-12 h-12 rounded-2xl bg-white border border-blue-200/80 flex items-center justify-center shadow-sm">
                      {c.icon}
                    </div>
                    <span className="text-[10px] font-mono font-bold uppercase tracking-wider px-2.5 py-1 rounded-full bg-[#FAF5FF] text-[#5278FF] border border-blue-200/60">
                      {c.badge}
                    </span>
                  </div>
